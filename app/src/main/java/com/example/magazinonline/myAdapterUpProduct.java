...
public class MyAdapterUpProduct extends RecyclerView.Adapter<MyAdapterUpProduct.modelViewholder> {
    ...
    public MyAdapterUpProduct.modelViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        // in cazul in care dam click pe un produs, vom fi trimisi catre activitatea ce arata detaliile produsului
    ...
    // clasa interioara ce are rol de viewholder (initializeaza view-urile ce afiseaza datele produsului pe ecran)
